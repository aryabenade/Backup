...
import { fetchBookedSlots, storeGroomingBooking } from '@/app/services/grooming/groomingBooking';
...
const GroomingBookingForm: React.FC = () => {
    ...
    const handleNextClick = async (e: React.FormEvent) => {
        ...
        if (date && timeSlot && selectedCity && user) { // Ensure selectedCity is not null before using its value
            const newBooking = {
                name,
                phoneNumber,
                email,
                ...
                petAggression,
                petAge,
                city: selectedCity.value, // Include city in the new booking data
                address,
                packageTitle: title,
                packagePrice: price,
                userId: user.id, // Include userId in the new booking data
